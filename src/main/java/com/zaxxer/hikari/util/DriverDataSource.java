 ...
 * @author leeco
 *
 * 核心方法 加载指定驱动 提供获取真实Connection方法
 */
public final class DriverDataSource implements DataSource
{
      ...
      if (driverClassName != null) {
         ...
         if (driver == null) {
            ...
            try {
               ...
               // 如果当前线程的上下文类加载器 null 则使用当前类的类加载器
               if (driverClass == null) {
   ...
   /**
    * 连接获取 委托给com.mysql.jdbc.Driver实现
    * @return
    * @throws SQLException
    */
   @Override
