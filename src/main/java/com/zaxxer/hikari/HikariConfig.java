...
public class HikariConfig implements HikariConfigMXBean
{
   ...
   /**
    * 从连接池中获取连接的最大超时时间 最低可接受250ms  默认超时时间30000ms
    * This property controls tha maximum number of milliseconds that a client will wait for a connection from the pool.
    ...
    *
    * 池中连接最大空闲时间
    * This property controls the maximum amount of time that a connection is allowed to site idle in the pool.
    * This setting only applies when minimumIdle is define to be less than maximumPoolSize.
    * Idle Connections will not retired once the pool reaches minimumIdle connections. Whether a connection is retired as idle or
    * not is subject to maximum variation of +30 seconds, and average of +15 seconds. A connection will never remove from the pool.
    * The minimum allowed value is 10000ms
    * @Default  600000ms
    */
   ...
   /**
    * This property controls the maximum lifetime fo connection in the pool. An in-use connection will n
    */
   private volatile long maxLifetime;

   /**
    * 总连接数 包括 空闲连接池/和正在使用中的
    */
    ...
    *
    * 最小空闲连接数
    * This property controls the minimum number of idle connection
    */
   ...
   /**
    * This property controls the default auto-commit behavior of connections returned from the poll.
    * It is a boolean value  默认自动提交
    * @Default true
    */
   ...
   {
      // 连接超时时间==0 means Integer.MAX_VALUE
      if (connectionTimeoutMs == 0) {
         this.connectionTimeout = Integer.MAX_VALUE;
      }
      // !=0 and < 250ms throw IllegalArgumentException
